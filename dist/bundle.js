...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,400;0,500;0,600;1,400&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `*{padding:0;margin:0;box-sizing:border-box;font-family:"Nunito",sans-serif;background-color:#e6e6e6}.container{width:800px;margin:0 auto;color:#32383c}.container form{display:flex;justify-content:center;align-items:center;gap:12px;font-size:24px}.container form #location{padding:6px 12px;background:#1f2023;border:1px solid #3c3f44;border-radius:4px;font-size:16px;color:#f7f8f8;height:32px;appearance:none;transition:border .15s ease 0s}.container form #location:focus{outline:none;box-shadow:none;border-color:#6499ff}.container form #submitBtn{display:inline-block;outline:none;cursor:pointer;border-radius:3px;font-size:14px;font-weight:500;line-height:16px;padding:2px 16px;height:32px;border:none;color:#fff;background-color:#5865f2;transition:background-color .17s ease,color .17s ease}.container form #submitBtn:hover{background-color:#4752c4}.container h1{color:#6499ff;user-select:none}.container .main-weather{display:flex;justify-content:center;gap:32px;align-items:center;text-align:center;user-select:none;margin-top:24px;height:30vh;flex-direction:column}.container .main-weather .location-wrapper .city{font-size:24px;margin-bottom:2px}.container .main-weather .location-wrapper .country{font-size:18px}.container .main-weather .weather-wrapper{gap:52px}.container .main-weather .weather-wrapper .img{display:none;width:90px;height:90px;background-size:cover;background-position:center;background-repeat:no-repeat;margin:0 auto 12px auto}.container .main-weather .weather-wrapper .temp{font-size:24px;font-weight:600;margin-top:12px}.container .main-weather .weather-wrapper .celsius{display:block;cursor:pointer}.container .main-weather .weather-wrapper .fahrenheit{display:none;cursor:pointer}`, ""]);
// Exports
...
isDevWebpackMode();
;// CONCATENATED MODULE: ./src/fetch-weather-api.js
...
;// CONCATENATED MODULE: ./src/content-dom.js
const contentDom = {
...
function renderWeatherInfo(DOM, data, isError) {
